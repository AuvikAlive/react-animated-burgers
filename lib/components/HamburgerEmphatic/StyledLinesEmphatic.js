...
exports.StyledLinesEmphatic = undefined;
...
var getIsActiveAfter = function getIsActiveAfter(buttonWidth) {
  return '\n  Reverse: -' + buttonWidth * 2 + 'px;\n  top: -' + buttonWidth * 2 + 'px;\n  transform: translate3d(-' + buttonWidth * 2 + 'px, ' + buttonWidth * 2 + 'px, 0) rotate(-45deg);\n  transition: Reverse 0.125s ease-out, top 0.05s 0.125s linear, transform 0.125s 0.175s cubic-bezier(0.075, 0.82, 0.165, 1);\n';
};

var StyledLinesEmphatic = exports.StyledLinesEmphatic = _StyledLines.StyledLines.extend(_templateObject, before, function (_ref2) {
